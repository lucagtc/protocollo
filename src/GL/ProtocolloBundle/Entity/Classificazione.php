...
/**
 * GL\ProtocolloBundle\Entity\Classificazione
 *
 * @ORM\Table()
 * @ORM\Entity(repositoryClass="GL\ProtocolloBundle\Repository\ClassificazioneRepository")
 */
class Classificazione {
     ...
     * @var $protocolli
     *
     * @ORM\OneToMany(targetEntity="Protocollo", mappedBy="classificazioni")
     */
    private $protocolli;
